...
<html>
<head>
	<cfoutput query="over" maxRows="1"><title>VAC-U-MAX | #over.c_title#</title>
	<meta name="description" content="#over.c_meta#"></cfoutput>
	    	...
	    	<div class="row-fluid">
	    		...
	    		<div id="prodCon" class="span9 well">
	    			<cfoutput query="over" group="c_title">
	    				<a href="quotePneumatic.cfm" class="quoteBtn pull-right">Request For Quote <span>&raquo;</span></a>
	    				<h2>#over.c_title#</h2>
			    			...
			    			<cfoutput>
	    						<td class="gradient">
	    							...
	    							<a href="product.cfm?<cfif url.cat neq "">cat<cfelse>subCat</cfif>=#over.c_url#&prod=#over.p_url#">
	    								<cfloop query="img">
					    					<cfif img.i_file neq ""><img src="prodImg/#img.i_file#" alt="#img.i_alt#" class="pull-left"></cfif>
	    								</cfloop>
