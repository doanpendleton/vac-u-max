...
<html>
<head>
	<title>VAC-U-MAX | Solicitud de cotización de transportadores de tornillos flexibles</title>
		...
		<div class="conIndent">
			<div class="row-fluid">
		    	<div id="inBan4" class="inBanner">
		    		<h1>Solicitud de cotización de transportadores de tornillos flexibles</h1>
	    			...
	    			<cfif showForm>
	    				<cfoutput>
							...
							<form action="#cgi.script_name#" method="post" id="form" enctype="multipart/form-data">
								...
								<h3>¿Cómo se enteró acerca de VAC-U-MAX?</h3>
								<p>
									<label class="checkLabel"><input type="checkbox" name="0_rep" id="0_rep" value="Rep Visit"> Visita de un representante</label>
								</p>
								<p>
									<label class="checkLabel"><input type="checkbox" name="0_mag_a" id="0_mag_a" value="Magazine Ad"> Anuncio de revista. ¿Qué publicación?</label>
									<input type="text" name="0_mag_b" id="0_mag_b">
								</p>
								<p>
									<label class="checkLabel"><input type="checkbox" name="0_trade_a" id="0_trade_b" value="Trade Show"> Feria comercial. ¿Qué feria comercial?</label>
									<input type="text" name="0_trade_b" id="0_trade_b">
								</p>
								<p>
									<label class="checkLabel"><input type="checkbox" name="0_int_a" id="0_int_a" value="Internet"> Internet. ¿Cuál fue su búsqueda?</label>
									<input type="text" name="0_int_b" id="0_int_b">
								</p>
								<p>
									<label class="checkLabel"><input type="checkbox" name="0_oth_a" id="0_oth_a" value="Other"> Otro medio</label>
									<input type="text" name="0_oth_b" id="0_oth_b">
								</p>
	    			...
	    			<cfelse>
	    				<cfoutput>
							...
							<cfsavecontent variable="message"> #date#<br>
								...
								<strong>Descarga del material desde el transportador</strong>: #form.2_matOut#<br>
