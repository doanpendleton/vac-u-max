...
<html>
<head>
	<cfoutput query="vacOver" maxRows="1"><title>VAC-U-MAX | #vacOver.c_title#</title>
	<meta name="description" content="#vacOver.c_meta#"></cfoutput>
	<cfinclude template="inc/head.cfm">
	<link href="css/jquery.fancybox.css?v=2.1.4" rel="stylesheet" type="text/css" media="screen" />
	<link href="css/jquery.fancybox-buttons.css?v=1.0.5" rel="stylesheet" type="text/css" media="screen" />
</head>
	    		...
	    		<div id="prodCon" class="span9 well">
	    			<cfoutput query="vacOver" group="c_title">
	    				<cfif url.cat eq "central-vacuum-systems" || url.subCat eq "custom-engineered-central-vacuum-cleaning-systems" || url.subcat eq "pre-engineered-systems-for-1-3-operators">
	    					<a href="quoteVacuumSystems.cfm" class="quoteBtn pull-right">Request For Quote <span>&raquo;</span></a>
	    				<cfelse>
	    					<a href="quoteVacuum.cfm" class="quoteBtn pull-right">Request For Quote <span>&raquo;</span></a>
	    				</cfif>
			    			...
			    			<cfoutput>
	    						<td class="gradient">
				    				<a href="vacProd.cfm?<cfif url.cat neq "">cat<cfelse>subCat</cfif>=#vacOver.c_url#&prod=#URLEncodedFormat(vacOver.v_item)#">
				    					<cfif vacOver.v_item eq "MDL2120"><h2 class="spT">Custom Engineered Central Vacuum Cleaning Systems</h2></cfif>
				    					<cfif vacOver.v_item eq "MDL1040"><h2 class="spT">Pre-Engineered Systems for 1-3 Operators</h2></cfif>
				    					<cfif vacOver.v_imgFile neq ""><img src="prodImg/#vacOver.v_imgFile#" alt="#vacOver.v_item#" class="pull-left"></cfif>
