...
<html>
<head>
	<title>VAC-U-MAX | Case Histories<cfif url.case neq ""><cfoutput query="case"> | #case.c_title#</cfoutput></cfif></title>
	    	...
	    	<div class="row-fluid">
	    		<div id="prodCon" class="span9 well">
		    		...
		    		<cfelse>
		    			...
		    			<cfoutput query="case">
		    				<cfif case.c_pdf neq ""><a href="#application.root#userfiles/cases/#case.c_pdf#" class="quoteBtn pull-right" target="_blank">Print PDF Version <span>&raquo;</span></a></cfif>
							<div class="clearfix"></div>
