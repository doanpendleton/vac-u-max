...
<html>
<head>
	<cfoutput query="prod"><title>VAC-U-MAX | <cfif not FindNoCase('<br class="visible-desktop">', prod.c_title)>#prod.c_title# | </cfif>#prod.p_title#</title>
	<meta name="description" content="#prod.p_meta#"></cfoutput>
	    		...
	    		<div id="prodCon" class="span9 well">
	    			<div class="colRight pull-right">
		    			<cfif url.prod eq "pulsonic-bin-activators">
		    				<a href="quotePulsonic.cfm?prod=<cfoutput query='prod'>#prod.p_url#</cfoutput>" class="quoteBtn">Request For Quote <span>&raquo;</span></a>
		    			<cfelseif url.prod eq "aero-mechanical-conveyors">
		    				<a href="quoteAerocon.cfm?prod=<cfoutput query='prod'>#prod.p_url#</cfoutput>" class="quoteBtn">Request For Quote <span>&raquo;</span></a>
		    			<cfelseif url.prod eq "flexible-screw-conveyors">
		    				<a href="quoteFlexibleScrew.cfm?prod=<cfoutput query='prod'>#prod.p_url#</cfoutput>" class="quoteBtn">Request For Quote <span>&raquo;</span></a>
		    			<cfelse>
		    				<a href="quotePneumatic.cfm?prod=<cfoutput query='prod'>#prod.p_url#</cfoutput>" class="quoteBtn">Request For Quote <span>&raquo;</span></a>
		    			</cfif>

	    				<cfoutput query="img">
		    				<cfif img.i_diagram eq 0 AND img.currentrow eq 1>
			    				<a class="fancybox-button disImg" rel="fancybox-button" href="prodImg/#img.i_file#" title="#img.i_cap#">
			    					<div id="zoom" class="btn"><i class="icon-zoom-in"></i></div>
									<img src="prodImg/#img.i_file#" alt="#img.i_alt#">
							...
							<cfelseif img.i_diagram eq 0 AND img.currentrow gt 1 AND img.currentrow lte 7>
								<a class="fancybox-button disImgSm" rel="fancybox-button" href="prodImg/#img.i_file#" title="#img.i_cap#">
			    					<img src="prodImg/#img.i_file#" alt="#img.i_alt#">
								</a>
								<cfif img.currentrow eq 4><div class="clearfix"></div></cfif>
							<cfelse>
								<a class="fancybox-button hide" rel="fancybox-button" href="prodImg/#img.i_file#" title="#img.i_cap#">
			    					<img src="prodImg/#img.i_file#" alt="#img.i_alt#">
								</a>
		    				</cfif>
						</cfoutput>
	    			...
	    			<cfoutput query="img" group="i_diagram"><cfif img.i_diagram eq 1><h3>Diagrams</h3></cfif></cfoutput>
	    			<cfoutput query="img">
	    				<cfif img.i_diagram eq 1><img src="prodImg/#img.i_file#" alt="#img.i_alt#"></cfif>
