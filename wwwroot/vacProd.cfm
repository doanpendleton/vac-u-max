...
<html>
<head>
	<cfoutput query="vac"><title>VAC-U-MAX | #vac.c_title# | #vac.v_title#</title>
	<meta name="description" content="#vac.v_meta#"></cfoutput>
		...
		<div class="conIndent">
	    	...
	    	<div class="row-fluid">
	    		...
	    		<div id="prodCon" class="span9 well">
	    			<div class="colRight pull-right">
	    				<cfoutput query="vac">
	    					<cfif url.prod eq "MDL1040" OR url.prod eq "MDL2120">
	    						<a href="quoteVacuumSystems.cfm?prod=#vac.v_item#" class="quoteBtn">Request For Quote <span>&raquo;</span></a>
	    					<cfelse>
								<a href="quoteVacuum.cfm?prod=#vac.v_item#" class="quoteBtn">Request For Quote <span>&raquo;</span></a>
	    					</cfif>
	    			...
	    			<cfif vac.v_desc neq "">#vac.v_desc#</cfif>
