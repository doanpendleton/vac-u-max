...
<cfinvoke
	...
	method="adminRfq"
	returnVariable="rfq">
	<cfinvokeargument name="sec" value="Aero-Mechanical Conveyors">
</cfinvoke>
		...
		<div class="conIndent">
	    	<div class="row-fluid">
	    		<div id="prodCon" class="span12 well">
	    			<h1>RFQ Aero-Mechanical</h1>
	    			<div class="clearfix"></div>

	    			<ul>
	    				<cfif isDefined('url.delete')><li class="success">Lead entry deletion successful.</li></cfif>
	    			</ul>
	    			...
	    			<cfif r.recordcount gt 0>
	    				<table class="table table-bordered" id="overview">
							...
							<cfoutput query="r">
								<td width="25%">
									<a href="##" class="delete icon-trash pull-right" rel="#r.id#&page=rfqAero&from=#form.from#&to=#form.to#" title="Delete"></a>
