		...
		<div class="conIndent">
	    	<div class="row-fluid">
	    		<div id="prodCon" class="span12 well">
    				<a href="vacCatFunctions.cfm" class="quoteBtn">Add Category</a>
	    			<h1>Categories</h1>
	    				...
	    				<ul id="sortActive" class="sortable">
							...
							<cfif cat.l_switch eq 1>
								<li id="act_#cat.c_id#" class="caseBox">
									<h4 class="pull-left"><a href="vacCatFunctions.cfm?cat=#cat.c_id#" title="Edit">#cat.c_title#</a></h4>
									<a href="##" class="delete icon-trash pull-right" rel="#cat.c_id#" title="Delete"></a>
									<a href="vacCatFunctions.cfm?cat=#cat.c_id#" class="edit icon-edit pull-right" title="Edit"></a>
								</li>
							</cfif>
		    				</cfoutput>
	    				</ul>
	...
	$(document).ready(function() {
		...
		$('#sortMessage').on('click', 'a.btnLink', function() {
			...
			$.ajax({
				type: 'POST',
				url: 'update.cfm',
				data: { section: 'vacCat', act: actSort, in: inSort},
		...
		$('.delete').click(function() {
			...
			var destination = 'delete.cfm?section=vacCat&cat=' + cat;
