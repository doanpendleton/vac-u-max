...
<cfinvoke
	...
	method="adminRfq"
	returnVariable="rfq">
	<cfinvokeargument name="sec" value="Pneumatic Conveying">
</cfinvoke>
	    		...
	    		<div id="prodCon" class="span12 well">
	    			...
	    			<cfif r.recordcount gt 0>
	    				<table class="table table-bordered" id="overview">
							...
							<cfoutput query="r">
								<td width="25%">
									<a href="##" class="delete icon-trash pull-right" rel="#r.id#&page=rfqPneu&from=#form.from#&to=#form.to#" title="Delete"></a>
